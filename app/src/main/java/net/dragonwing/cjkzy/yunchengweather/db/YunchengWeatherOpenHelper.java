...
/**
 *  sql-statements that created db table
 * Created by xuncl on 2015/12/4.
 */
public class YunchengWeatherOpenHelper extends SQLiteOpenHelper {
    ...
    public YunchengWeatherOpenHelper(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
